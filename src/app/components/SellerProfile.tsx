...
export function SellerProfile() {
  ...
  const woodPhotoUrl = woodImages[selectedWood as keyof typeof woodImages] || woodImages['Eucaliptus'];
              ...
              <div className="mt-6 text-sm text-slate-700">
                ...
                <div className="overflow-hidden rounded-[32px] bg-slate-100 shadow-[0_25px_60px_rgba(15,23,42,0.12)] transition-all duration-500 ease-out">
                  <img
                    ...
                    className={`h-56 w-full object-cover transition-all duration-300 ease-out ${woodImageLoaded ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}
                  />
                </div>
